...
| [7단계 주문 계획·위험검사 검증](../qa/phase-7-order-planning-verification.md) | `docs/qa/phase-7-order-planning-verification.md` | 검증 완료 (계획 계층, 실계좌 잔고 조회, 모의매매 콘솔 화면, 주문 제출 계층의 차단·동기화 경로) · 실제 주문 제출·체결은 다음 거래일 장중 대기 |
