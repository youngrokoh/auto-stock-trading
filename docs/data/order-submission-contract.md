...
- 자동 스케줄 제출은 2026-08-25에 [ADR-0015](../decisions/0015-scheduled-order-submission.md)로
  구현했다(계획-제출 체인, 15분 주기 09:05~15:05 KST, 하루 한 번 사람이 켜기, 차단은 알림으로, 모의
  전용). 후보는 [ADR-0016](../decisions/0016-live-signal-source.md)의 저장된 신호에서 나온다. 기본
  Compose에는 없고 `infra/compose.order-submission-schedule.yaml`로만 켠다.
